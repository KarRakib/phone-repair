...
function Footer() {
  ...
  return (
    <footer className="footer flex justify-between items-center p-4 bg-[#1f2937] text-neutral-content">
      <div className="items-center grid-flow-col">
        <img  className='rounded-lg w-28' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQq9rVEknTWiL7LZWCeOJCvFY0WTaPXE_-3w&usqp=CAU" alt="" />
        </div>
